...
return false;});}});
function fileHandler(file){var fileReader=new FileReader();fileReader.onabort=function(e){if(settings.onClientAbort){settings.onClientAbort(e,file);}};
...
//FIXME - understand ${id} value in templates
xmlHttpRequest.open("POST",settings.postUrl+"?FolderID="+$('#UploadFolderID_FileDataObjectManager_Popup_UploadifyForm_UploadedFiles').val(),true);
